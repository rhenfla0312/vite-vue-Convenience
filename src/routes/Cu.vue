...
export default {
  ...
  mounted() {
    if(localStorage.getItem('search__data') !== "") {
      ...
      if(localStorage.getItem('oneClick__data') != "") {
        // 1+1데이터
        this.totalData = false
        this.oneData = true
        this.twoData = false
        ...
        axios({
          method: "GET",
          url: `http://54.180.193.83:8081/Main/event/CU/?search=${localStorage.getItem('search__data')}`
        }).then((res) => {
          console.log(res)
          this.datas = res.data.results
          localStorage.setItem('search__data', this.searchData)
  ...
  <div class="convenience">
    <div class="inner">
      <div class="convenience__name">
        <RouterLink @click="search__data()" to="/convenience/cu" class="__name __cuName">CU</RouterLink>
